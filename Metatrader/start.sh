...
# Using the specific Python 3.13 from our virtual environment
/opt/venv/bin/python -m pymt5linux --host $MT5_HOST --port $mt5server_port "$wine_executable python.exe" &
